...
import com.smw.spring.aop.aspectj.AspectJExpressionPointcut;
import com.smw.spring.aop.framework.ProxyFactory;
import com.smw.spring.aop.framework.ReflectiveMethodInvocation;
import com.smw.spring.aop.framework.adapter.MethodBeforeAdviceInterceptor;
import com.smw.spring.context.support.ClassPathXmlApplicationContext;
import com.smw.spring.test.bean.IUserService;
import com.smw.spring.test.bean.UserService;
import com.smw.spring.test.bean.UserServiceBeforeAdvice;
import com.smw.spring.test.bean.UserServiceInterceptor;
...
class ApiTest {
  ...
  public void init() {
    ...
    advisedSupport.setMethodMatcher(new AspectJExpressionPointcut(
        "execution(* com.smw.spring.test.bean.IUserService.*(..))"));
  }
  ...
  void test_advisor() {
    ...
    advisor.setExpression("execution(* com.smw.spring.test.bean.IUserService.*(..))");
  ...
  void test_proxy_method() {
    ...
    IUserService proxy = (IUserService) Proxy.newProxyInstance(
        Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(),
